...
using System.Text; // Adicionar para System.Text.Encoding
...
namespace Exo.WebApi.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        */
        ...
        [HttpPost] // Adicionado o atributo HTTP POST
        public IActionResult Post(Usuario usuario)
        {
            ...
            var key = new 
            SymmetricSecurityKey(Encoding.UTF8.GetBytes("exoapi-chave-autenticacao")); // Usando 'Encoding' de System.Text
